# perf-critical-service — High-performance real-time service
...
## Key Dependencies
- Use React Query (TanStack Query) for all server data fetching — never raw useEffect + fetch
- Define query keys as constants. Invalidate related queries after mutations
